...
/*
 * 4. ƒано целое число K и массив из дес€ти целых ненулевых чисел. ¬ывести номер первого числа в массиве, большего K. ≈сли таких чисел нет, то вывести 0.
 * 5. ƒано целое число K и массив из дес€ти целых ненулевых чисел. ¬ывести номер последнего числа в массиве, большего K. ≈сли таких чисел нет, то вывести 0.
 * 6. ƒано вещественное число B, целое число N и массив из N целых чисел, упор€доченных по возрастанию. ¬ывести элементы массива вместе с числом B, сохран€€ упор€доченность выводимых чисел.
 * 7. ƒано целое число N и массив из N целых чисел, упор€доченный по возрастанию. ƒанный набор может содержать одинаковые элементы. ¬ывести в том же пор€дке все различные элементы данного массива.
 */
